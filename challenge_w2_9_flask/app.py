...
def main():
    ...
    file1 = File(title='Hello java',content='File Content - Java is cool ',category=java)
    file2 = File(title='Hello Python',content='File Content -Python is cool',category=python)
    db.session.add(java)
